...
------
TEST 2 ([1], [2], [3], and [4] are all valid)
------
[4]
...
------
TEST 5 ([0, 1, 2] and [0, 2, 1] and are both valid)
------
[0, 2, 1]

------
TEST 6 (There are multiple answers to the array but you must get 177)
------
[5, 4, 6, 3, 2, 1, 0]
177

------
TEST 7 (There are multiple answers to the array but you must get 360)
------
...
public class CrazyTester_Version2 {
  public static void main(String[] args) {
    ...
    *****/
    ...
    // Base Case 2
    System.out.println("------");
    System.out.println("TEST 2 ([1], [2], [3], and [4] are all valid)");
    System.out.println("------");
    weights = new int[] {50}; 
		deadlines = new int[] {4};
		m = weights.length;
    ...
    // Short Tricky Case
    System.out.println("------");
    System.out.println("TEST 5 ([0, 1, 2] and [0, 2, 1] and are both valid)");
    System.out.println("------");
    weights = new int[] {20, 40, 40}; 
    ...
    // Medium Tricky Case
    System.out.println("------");
    System.out.println("TEST 6 (There are multiple answers to the array but you must get 177)");
    System.out.println("------");
    weights = new int[] {35, 35, 2, 30, 25, 50, 20}; 
		deadlines = new int[] {5, 4, 6, 3, 4, 1, 2};
		m = weights.length;
		schedule =  new HW_Sched(weights, deadlines, m);
		res = schedule.SelectAssignments();
    System.out.println(Arrays.toString(res));
    ...
    // Long Tricky Case
    System.out.println("------");
    System.out.println("TEST 7 (There are multiple answers to the array but you must get 360)");
    System.out.println("------");
...
/* VERSION 2 CHANGES
Got rid of part 3 tests that contained weights and deadlines of 0
*/